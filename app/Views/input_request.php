...
<header>
    <div class="nav-bar">
        ...
        <div class="menu" style="width:100%; display: flex; justify-content:right; align-items:center;">
            <div class="menu">
                <a href="/services" class="line-animation" style="margin-right: 1rem;">SERVICES</a>
...
<div class="container">
    <div class="form-container">
        <form action="/request/input" method="POST">
            <div class="form-group">
                <label for="title">Title:</label>
                <input type="text" id="title" name="title" required onfocus="animateInput(this)" onblur="resetInput(this)">
            </div><br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="jobRequirement" name="jobRequirement" required>
            </div><br>
            <div class="form-group">
                <label for="budget">Min Budget:</label>
                <input type="number" id="minbudget" name="minbudget" required>
            </div><br>
            <div class="form-group">
